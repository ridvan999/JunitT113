...
public class C02_KlavyeActions extends TestBase {
    ...
    public void test01() throws InterruptedException {
     /*   //1- https://www.facebook.com adresine gidelim ve cookies'i kabul edelim
        ...
        Actions actions=new Actions(driver);
        WebElement formFirstName=driver.findElement(By.xpath("(//*[@name=\"firstname\"])"));
        actions.click(formFirstName).sendKeys("mali")
                                    .sendKeys(Keys.TAB)
                                        .sendKeys("falitiko")
                                        .sendKeys(Keys.TAB)
                                        .sendKeys("45326421682")
                                        .sendKeys(Keys.TAB)
                                        .sendKeys("elli5")
                                        .sendKeys(Keys.TAB)
                                        .sendKeys(Keys.TAB)
