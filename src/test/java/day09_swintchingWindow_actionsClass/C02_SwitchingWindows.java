...
//******************************************************************************************************************//
        ...
        Assert.assertEquals(expectedTextYazisi,actualText);
        //● Sayfa başlığının(title) “The Internet” olduğunu doğrulayın.
        String expectedTitle="The Internet";
        String actualTitle=driver.getTitle();
        Assert.assertEquals(expectedTitle,actualTitle);
        ...
        //dogrulayin.
        Set <String> ikiWHD=driver.getWindowHandles();
        String ikinciWHD="";
        for (String eachWHD:ikiWHD
             ) {
        if (!eachWHD.equals(WHD));
            ikinciWHD=eachWHD;
   }

        System.out.println("==================================================================");

        System.out.println(ikinciWHD);// ikincinin whd sini gorduk
        driver.switchTo().window(ikinciWHD);
        String expectedTitleNewWindow="New Window";
        String actualTitie=driver.getTitle();
        Assert.assertEquals(expectedTitleNewWindow,actualTitie);

        //● Bir önceki pencereye geri döndükten sonra sayfa başlığının “The Internet”
        //olduğunu doğrulayın
        driver.switchTo().window(WHD);
        expectedTitle="The Internet";
        actualTitie=driver.getTitle();
        Assert.assertEquals(expectedTitle,actualTitle);
