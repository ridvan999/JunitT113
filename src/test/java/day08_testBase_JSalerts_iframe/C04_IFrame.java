...
public class C04_IFrame extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        //  - Text Box’a “Merhaba Dunya!” yazin.
        WebElement frameElementi= driver.findElement(By.id("mce_0_ifr"));// once normal bir html locate i alir gibi kodumuzu yazdik
        driver.switchTo().frame(frameElementi); // bunun bir frame elementi oldugunu anadigimizda frame e kaydirdik (switchto ve frame ile)
        ...
        /*
            ...
            NOT: alert de boyle bir seye gerek yoktur
         */
